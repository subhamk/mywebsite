...
# Publication type, see config.toml line 184
publication_types = ["2"]
...
abstract_short = "Roads boost manufacturing productivity by lowering transport costs. We find that a 1% increase in road density raises total factor productivity of Indian manufacturing plants by 0.25%, on average. A closer examination reveals that the effect varies by plant characteristics and road type."
