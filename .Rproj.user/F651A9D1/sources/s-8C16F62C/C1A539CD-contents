+++
title = "Political Competition and Public Healthcare: Evidence from India"
...
abstract_short = "We examine the causal effect of political competition, measured by the effective number of parties (ENP), on healthcare access and health centre capacity. We find that incumbents prioritise more visible components of healthcare (eg. access to health centres) which are more electorally rewarding over less visible components (eg. medical personnel). This leads to misallocation in healthcare."
